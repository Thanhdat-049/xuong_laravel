                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div
                                                                            class="avatar-sm bg-light rounded p-1 me-2">
                                                                            <img src="{{ asset('default/assets/images/products/img-4.png') }}"
                                                                                alt=""
                                                                                class="img-fluid d-block" />
                                                                        </div>
                                                                        <div>
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('default/assets/images/companies/img-1.png') }}"
                                                                                alt=""
                                                                                class="avatar-sm p-2" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('default/assets/images/companies/img-2.png') }}"
                                                                                alt=""
                                                                                class="avatar-sm p-2" />
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('default/assets/images/companies/img-3.png') }}"
                                                                                alt=""
                                                                                class="avatar-sm p-2" />
                                                                        </div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('default/assets/images/companies/img-8.png') }}"
                                                                                alt=""
                                                                                class="avatar-sm p-2" />
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('default/assets/images/companies/img-5.png') }}"
                                                                                alt=""
                                                                                class="avatar-sm p-2" />
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('default/assets/images/users/avatar-1.jpg') }}"
                                                                                alt=""
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-2">
                                                                            <img src="{{ asset('default/assets/images/users/avatar-4.jpg') }}"
                                                                                alt=""
                                                                                class="avatar-xs rounded-circle" />
                                                                        </div>
...
@section('style-libs')
   <!-- jsvectormap css -->
    <link href="{{ asset('default/assets/libs/jsvectormap/css/jsvectormap.min.css') }}" rel="stylesheet"
        type="text/css" />
